...
for target in target_obj:
    board_crawl.crawl(target['url'], target['list_url'], target['list_tag'], target['list_key'], target['list_num_tag'], target['list_num_key'], target['ele_url'], target['ele_url_key'], target['ele_date_tag'], target['ele_date_key'], target['content_tag'], target['content_key_type'], target['content_key'], target['dest'])
